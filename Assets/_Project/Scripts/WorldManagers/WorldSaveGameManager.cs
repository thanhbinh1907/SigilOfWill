	...
	public class WorldSaveGameManager : MonoBehaviour
	{
		...
		private void NewGame()
		{
			...
			if (currentCharacterData != null)
			{
				...
				// Người chơi luôn bắt đầu với cây Sky Staff
				if (WorldItemDatabase.instance != null)
				{
					WeaponItem skyStaff = WorldItemDatabase.instance.GetWeaponByName("Sky Staff");
					if (skyStaff != null)
					{
						currentCharacterData.itemsInventoryIDs.Add(skyStaff.itemID);
					}
				}
			}
