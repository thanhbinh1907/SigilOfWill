...
namespace SG
{
	...
	public class CharacterSaveData
    {
		...
		[Header("Portal & Interactable Activations")]
		public SerializableDictionary<int, bool> activatedInteractables;
		...
		public CharacterSaveData()
		{
			...
			activatedInteractables = new SerializableDictionary<int, bool>();
